...
const WhatsAppButton = () => {
  const handleWhatsAppClick = () => {
    const phoneNumber = '+8617765399420'; 
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button
        ...
        className="bg-green-500 hover:bg-green-600 text-white p-5 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 group"
